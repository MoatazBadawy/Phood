package com.phood.recipes.ui.viewmodel

import androidx.lifecycle.SavedStateHandle
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.phood.recipes.domain.usecases.GetRecipeDetailsByIdUseCase
import com.phood.recipes.domain.usecases.SetRecipeFavoriteStatusUseCase
import com.phood.recipes.ui.viewmodel.mapper.toRecipeUIModel
import com.phood.recipes.ui.viewmodel.model.RecipeUI
import com.phood.recipes.ui.viewmodel.model.RecipesDetailsUIState
...
class RecipeDetailsViewModel @Inject constructor(
    ...
    private var _recipeId = state.get<String>("recipeId") ?: ""
    ...
    private fun getRecipeDetails() {
        viewModelScope.launch {
            try {
                getRecipesDetailsUseCase(_recipeId).collectLatest { recipe ->
